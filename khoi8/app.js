...
const GOOGLE_SHEET_API_URL = 'https://script.google.com/macros/s/AKfycbwGAwqRI3z5UKEr4sArOW9qxheZ9l5jv4yDpXPSV_ZHr5V6fdQHqcV8GPQ8y2Qi7ctI/exec';
...
function renderResourceLinks() {
    const gradeInfo = { sgk_pdf: "SGK - TIN HOC 8 - KNTT.pdf", sgv_pdf: "SGV-Tin8-KNTT.pdf" };
